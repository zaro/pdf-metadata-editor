...
public class TylerConfigurator extends TylerConfiguratorBase implements Configurator {
    ...
    public Configurator.ExecutionStatus configure(LoggerContext loggerContext) {
        ...
        propertyModelHandlerHelper.handlePropertyModel(this, "LOG_FILE", "${logFileName:-application.log}", "", "", "");
        propertyModelHandlerHelper.handlePropertyModel(this, "LOG_LEVEL", "${logLevel:-info}", "", "", "");
        propertyModelHandlerHelper.handlePropertyModel(this, "DEV_LOG", "${devLog:-false}", "", "", "");
        if (property("DEV_LOG").equalsIgnoreCase("true")) {
            this.appenderSTDOUT = setupAppenderSTDOUT();
        }
        this.appenderFILE = setupAppenderFILE();
        Logger logger_ROOT = setupLogger("ROOT", subst("${LOG_LEVEL}"), null);
        if (property("DEV_LOG").equalsIgnoreCase("true")) {
