...
public class PDFMetadataEditWindow {
	...
	private void initialize() {
		...
		frmPdfMetadataEditor.getContentPane()
				.setLayout(
						new MigLayout("insets 5", "[grow,fill]",
								"[][grow,fill][grow]"));
		...
		JPanel xmlBasicMetaPanel = new JPanel();
		...
		JPanel xmlPdfMetaPanel = new JPanel();
		...
		JPanel xmpDcMetaPanel = new JPanel();
		...
		panel_4.setLayout(new MigLayout("insets 0",
		...
		onsaveCopyBasicTo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				prefs.putBoolean("onsaveCopyXmpTo",
						onsaveCopyXmpTo.isSelected());
				prefs.putBoolean("onsaveCopyBasicTo",
						onsaveCopyBasicTo.isSelected());
			}
		});
